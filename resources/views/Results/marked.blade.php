...
@endif
<form id="form" method="post" action="{{route('marked.store')}}" enctype="multipart/form-data">
@csrf
<div class="col-sm-3">
...
<div class="pull-right">
    <button class="btn btn-primary" onclick="window.open('/Markedsheet/Post/Single','_parent')">
        Upload Individual MarkSheet
    </button>
</div>
