  ...
  <aside class="left-side sidebar-offcanvas">
      ...
      <section class="sidebar">
          ...
          <ul class="sidebar-menu" style="font-size:10px; font-family:'Courier New', Courier, monospace">
              ...
              <li class="treeview">
                <a href="#">
                    <i class="fa fa-times-circle"></i> <span>Academic Documents</span>
                    <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                <li><a href="{{route('records.index')}}"><i class="fa fa-plus-circle"></i>Records of Work</a></li>
                <li><a href="{{route('lessons.index')}}"><i class="fa fa-eye"></i>Lesson Plans</a></li>
                <li><a href="{{route('schemes.index')}}"><i class="fa fa-eye"></i>Schemes of Works</a></li>
