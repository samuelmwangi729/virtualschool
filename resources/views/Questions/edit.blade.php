...
<div class="container-fluid">
   ...
   @endif
<form id="subject-form" method="POST" action="{{route('questions.update',[$question->id])}}">
    @csrf
        <fieldset>
            ...
            <div class="row form-group">
                ...
                <input type="number" class="form-control" placeholder="Enter Marks . Eg 10" name="marks" maxlength="2" value="{{$question->marks}}">
                </div>
                <div class="col-sm-3">
                ...
                <textarea class="textarea" placeholder="Type your question here" name="question" style="width: 100%; height: 125px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{$question->question}}</textarea>
                </div>
            </div>
        </fieldset>
        <div class="pull-center">
           ...
           ><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Update Question</button>
        </div>
    </form>
</div>
@stop