                    ...
                    <form method="POST" action="{{ route('user.register') }}">
                        ...
                        <div class="form-group row">
                           <div class="col-sm-6">
                            ...
                            <div class="col">
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="pname" value="Principal"  placeholder="Optional/">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="col-sm-6 col-sm-offset-4">
                             <label class="label-control" for="Select Level">
                                 Level
                             </label>
