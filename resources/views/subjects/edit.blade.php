...
<div class="container-fluid">
   ...
   @endif
<form id="subject-form" method="POST" action="{{route('subject.update',[$subject->id])}}">
    @csrf
        <fieldset>
            ...
            <div class="row form-group">
                ...
                <input type="number" class="form-control" placeholder="Enter Subject Code" name="subjectCode" value="{{$subject->subjectCode}}">
                </div>
                <div class="col-sm-4">
                    <label for="subjectName" class="label-control">Subject Name</label>
                <input type="text" class="form-control" placeholder="Enter Subject Name" name="subjectName" value="{{$subject->subjectName}}">
                </div>
            </div>
        </fieldset>
