        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <td><img src="{{asset('uploads/Students/'.$student->Passport)}}" style="height:30px;width:30px"></td>
                    ...
                    <td><a href=""><i class="fa fa-eye" style="color:green"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=""><i class="fa fa-pencil" style="color:blue"></i></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href=""><i class="fa fa-trash-o" style="color:red"></i></a></td>
                    </tr>
                @endforeach
            </tbody>
        </table>
