...
<div class="container-fluid">
   ...
   @endif
<form id="subject-form" method="POST" action="{{route('topics.store')}}">
    @csrf
        <fieldset>
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control" placeholder="Enter Topic. Eg. Genetics" name="topic">
                </div>
            </div>
        </fieldset>
        <div class="pull-center">
           ...
           ><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;Post Topic</button>
        </div>
    </form>
</div>
@stop